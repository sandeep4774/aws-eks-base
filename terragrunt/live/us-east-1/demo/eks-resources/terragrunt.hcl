...
dependency "aws-resources" {
  ...
  mock_outputs = {
    ...
    eks_oidc_provider_arn = "arn:aws:iam::730809894724:oidc-provider/oidc.eks.us-east-1.amazonaws.com/id/D55EEBDFE5510B81EEE2381B88888888"
    ssl_certificate_arn    = "arn:aws:acm:us-east-1:730809894724:certificate/fa029132-86ab-7777-8888-8e1fd5c56c29"
  }
}
